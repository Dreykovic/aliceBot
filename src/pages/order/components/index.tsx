...
//   next: boolean;
// };
// const StepButton: React.FC<ActionType> = (props: ActionType) => {
//   return (
//     <>
//       {props.next ? (
//         <button className=" btn btn-ghost">
//           Continuer
//           <ArrowRightShort className="w-6 h-6" />
//         </button>
//       ) : (
//         <button className=" btn btn-ghost">
...
//   isLoading: boolean;
// };
// const SubmitButton: React.FC<SubmitType> = (props: SubmitType) => {
//   return (
//     <div className="w-full flex items-center justify-center flex-shrink">
//       <button
//         className="btn-wide btn font-bold mb-6 rounded-btn"
//         type="submit"
//         disabled={props.isLoading} // Désactive le bouton lorsque isLoading est true
//       >
//         {props.isLoading ? (
